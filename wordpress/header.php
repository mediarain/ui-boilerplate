...
<head>
	...
	<link type="img/png" rel="icon" href="<?php echo esc_url( get_template_directory_uri() ); ?>/img/favicon.png">
		...
		<header>
			...
			<div class="row-one row">
				<div class="container">
					...
					<?php wp_nav_menu( array( 'theme_location' => 'secondary', 'menu_class' => 'toolbar' ) ); ?>
